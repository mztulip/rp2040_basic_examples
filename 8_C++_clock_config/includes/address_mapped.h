...
#define check_hw_layout(type, member, offset) _Static_assert(offsetof(type, member) == (offset), "hw offset mismatch")
#define check_hw_size(type, size) _Static_assert(sizeof(type) == (size), "hw size mismatch")
...
//I commented this because I do not know what ADDRESS_ALIAS is
