...
GPP_FLAGS="$GCC_FLAGS -fno-exceptions -fno-threadsafe-statics -fno-use-cxa-atexit -fno-rtti -fmessage-length=0 -fsigned-char -Wall -Wextra -ffreestanding -fno-builtin -frecord-gcc-switches"
INCLUDES_BASIC="-I includes"
INLCUDES="$INCLUDES_BASIC"
DEFINES="-DPICO_RP2040"
set -x #echo on
...
filename=main
file="$TOOLCHAIN_GPP ./$filename.cpp $INLCUDES -o build/$filename.o $GPP_FLAGS $DEFINES"
$file
